...
namespace Recipe.Entities.Migrations
{
    ...
    [Migration("20240815183040_MyUserActive")]
    partial class MyUserActive
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 8, 15, 18, 30, 39, 726, DateTimeKind.Utc).AddTicks(2013));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Comments", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 15, 18, 30, 39, 727, DateTimeKind.Utc).AddTicks(5882));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Food", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 15, 18, 30, 39, 728, DateTimeKind.Utc).AddTicks(2231));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Info", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 15, 18, 30, 39, 729, DateTimeKind.Utc).AddTicks(8930));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.MyUser", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 15, 18, 30, 39, 730, DateTimeKind.Utc).AddTicks(2092));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Photos", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 15, 18, 30, 39, 730, DateTimeKind.Utc).AddTicks(5244));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 15, 18, 30, 39, 730, DateTimeKind.Utc).AddTicks(9522));
