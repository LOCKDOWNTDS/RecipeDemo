...
namespace Recipe.Entities.Migrations
{
    ...
    [Migration("20240721202300_newPhoto")]
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 7, 21, 20, 22, 59, 180, DateTimeKind.Utc).AddTicks(9161));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Comments", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 21, 20, 22, 59, 182, DateTimeKind.Utc).AddTicks(4093));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Food", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 21, 20, 22, 59, 182, DateTimeKind.Utc).AddTicks(9330));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Info", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 21, 20, 22, 59, 183, DateTimeKind.Utc).AddTicks(2144));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Photos", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 21, 20, 22, 59, 183, DateTimeKind.Utc).AddTicks(4716));
