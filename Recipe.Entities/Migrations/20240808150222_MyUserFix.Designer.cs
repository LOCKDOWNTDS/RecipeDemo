...
namespace Recipe.Entities.Migrations
{
    ...
    [Migration("20240808150222_MyUserFix")]
    partial class MyUserFix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 8, 8, 15, 2, 21, 496, DateTimeKind.Utc).AddTicks(3182));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Comments", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 15, 2, 21, 497, DateTimeKind.Utc).AddTicks(4035));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Food", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 15, 2, 21, 497, DateTimeKind.Utc).AddTicks(9397));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Info", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 15, 2, 21, 499, DateTimeKind.Utc).AddTicks(436));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.MyUser", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 15, 2, 21, 499, DateTimeKind.Utc).AddTicks(3223));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Photos", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 15, 2, 21, 499, DateTimeKind.Utc).AddTicks(5844));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 15, 2, 21, 499, DateTimeKind.Utc).AddTicks(9721));
