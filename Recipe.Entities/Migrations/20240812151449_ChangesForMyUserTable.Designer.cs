...
namespace Recipe.Entities.Migrations
{
    ...
    [Migration("20240812151449_ChangesForMyUserTable")]
    partial class ChangesForMyUserTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 8, 12, 15, 14, 48, 815, DateTimeKind.Utc).AddTicks(8887));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Comments", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 12, 15, 14, 48, 818, DateTimeKind.Utc).AddTicks(2754));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Food", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 12, 15, 14, 48, 819, DateTimeKind.Utc).AddTicks(4669));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Info", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 12, 15, 14, 48, 823, DateTimeKind.Utc).AddTicks(3391));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.MyUser", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 12, 15, 14, 48, 823, DateTimeKind.Utc).AddTicks(8501));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Photos", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 12, 15, 14, 48, 824, DateTimeKind.Utc).AddTicks(1888));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 12, 15, 14, 48, 824, DateTimeKind.Utc).AddTicks(7324));
