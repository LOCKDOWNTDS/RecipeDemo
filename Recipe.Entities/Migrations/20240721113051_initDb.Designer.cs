...
namespace Recipe.Entities.Migrations
{
    ...
    [Migration("20240721113051_initDb")]
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 7, 21, 11, 30, 50, 548, DateTimeKind.Utc).AddTicks(8793));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Comments", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 21, 11, 30, 50, 549, DateTimeKind.Utc).AddTicks(9327));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Food", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 21, 11, 30, 50, 550, DateTimeKind.Utc).AddTicks(4176));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Photos", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 21, 11, 30, 50, 550, DateTimeKind.Utc).AddTicks(7099));
