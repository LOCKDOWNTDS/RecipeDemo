...
namespace Recipe.Entities.Migrations
{
    ...
    [Migration("20240817233032_foodAct")]
    partial class foodAct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 8, 17, 23, 30, 30, 858, DateTimeKind.Utc).AddTicks(5772));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Comments", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 17, 23, 30, 30, 861, DateTimeKind.Utc).AddTicks(2334));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Food", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 17, 23, 30, 30, 863, DateTimeKind.Utc).AddTicks(1475));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Info", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 17, 23, 30, 30, 872, DateTimeKind.Utc).AddTicks(989));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.MyUser", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 17, 23, 30, 30, 872, DateTimeKind.Utc).AddTicks(5867));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Photos", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 17, 23, 30, 30, 872, DateTimeKind.Utc).AddTicks(9580));
            ...
            modelBuilder.Entity("Recipe.Entities.Model.Concrete.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 8, 17, 23, 30, 30, 873, DateTimeKind.Utc).AddTicks(5796));
